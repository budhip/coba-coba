...
type invmtTransformer struct {
	baseWalletTransactionTransformer
}

func (t invmtTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
