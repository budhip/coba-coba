...
type wollcTransformer struct {
	baseWalletTransactionTransformer
}

func (t wollcTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
