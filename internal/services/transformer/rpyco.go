...
type rpycoTransformer struct {
	baseWalletTransactionTransformer
}

func (t rpycoTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
