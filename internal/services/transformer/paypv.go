...
type paypvTransformer struct {
	baseWalletTransactionTransformer
}

func (t paypvTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
