...
type siveaTransformer struct {
	baseWalletTransactionTransformer
}

func (t siveaTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
