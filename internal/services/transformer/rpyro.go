...
type rpyroTransformer struct {
	baseWalletTransactionTransformer
}

func (t rpyroTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
