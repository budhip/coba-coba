...
type tupppTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupppTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
