...
type insplTransformer struct {
	baseWalletTransactionTransformer
}

func (t insplTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
