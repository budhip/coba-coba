...
// tupwxTransformer is a transformer to acuan transaction for TUPWX transaction type
type tupwxTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupwxTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
