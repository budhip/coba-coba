...
type admcvTransformer struct {
	baseWalletTransactionTransformer
}

func (t admcvTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
