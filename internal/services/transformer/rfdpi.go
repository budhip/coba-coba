...
type rfdpiTransformer struct {
	baseWalletTransactionTransformer
}

func (t rfdpiTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
