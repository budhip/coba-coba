...
type mfmtpTransformer struct {
	baseWalletTransactionTransformer
}

func (t mfmtpTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
