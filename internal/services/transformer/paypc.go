...
type paypcTransformer struct {
	baseWalletTransactionTransformer
}

func (t paypcTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
