...
type dsbaaTransformer struct {
	baseWalletTransactionTransformer
}

func (t dsbaaTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	meta := parentWalletTransaction.Metadata
	meta = t.MutateMetadataByAccountEntity(entityCode, meta)

	return []models.TransactionReq{
		{
			TransactionID:   uuid.New().String(),
			FromAccount:     t.GetSourceAccountForDSBAA(parentWalletTransaction),
