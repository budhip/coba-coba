...
type itdedTransformer struct {
	baseWalletTransactionTransformer
}

func (t itdedTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
