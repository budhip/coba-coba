...
type admviTransformer struct {
	baseWalletTransactionTransformer
}

func (t admviTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
