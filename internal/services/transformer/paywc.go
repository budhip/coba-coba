...
type paywcTransformer struct {
	baseWalletTransactionTransformer
}

func (t paywcTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
