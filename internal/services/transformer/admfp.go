...
type admfpTransformer struct {
	baseWalletTransactionTransformer
}

func (t admfpTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
