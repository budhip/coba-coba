...
type admptTransformer struct {
	baseWalletTransactionTransformer
}

func (t admptTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
