...
// tupbaTransformer is a transformer to acuan transaction for TUPBA transaction type
type tupbaTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupbaTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
