...
type mfmppTransformer struct {
	baseWalletTransactionTransformer
}

func (t mfmppTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
