...
type rfdvpTransformer struct {
	baseWalletTransactionTransformer
}

func (t rfdvpTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			ToAccount:       t.config.AccountConfig.DepositVoucher,
