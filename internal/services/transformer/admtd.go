...
type admtdTransformer struct {
	baseWalletTransactionTransformer
}

func (t admtdTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			FromAccount:     t.config.AccountConfig.OperationalReceivableDiscountAdminFeeAFA, // budget AFA.
