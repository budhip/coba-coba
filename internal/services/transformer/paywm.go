...
type paywmTransformer struct {
	baseWalletTransactionTransformer
}

func (t paywmTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
