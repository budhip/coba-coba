...
type rfdcbTransformer struct {
	baseWalletTransactionTransformer
}

func (t rfdcbTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
