...
type mfmmpTransformer struct {
	baseWalletTransactionTransformer
}

func (t mfmmpTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
