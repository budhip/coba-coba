...
type sivedTransformer struct {
	baseWalletTransactionTransformer
}

func (t sivedTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
