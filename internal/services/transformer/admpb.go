...
type admpbTransformer struct {
	baseWalletTransactionTransformer
}

func (t admpbTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
