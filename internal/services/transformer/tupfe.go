...
type tupfeTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupfeTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
