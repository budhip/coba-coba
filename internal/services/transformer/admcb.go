...
type admcbTransformer struct {
	baseWalletTransactionTransformer
}

func (t admcbTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
