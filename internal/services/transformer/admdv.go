...
type admdvTransformer struct {
	baseWalletTransactionTransformer
}

func (t admdvTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
