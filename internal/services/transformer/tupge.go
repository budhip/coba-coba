...
// tupgeTransformer is a transformer to acuan transaction for TUPGE transaction type
type tupgeTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupgeTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			FromAccount:     t.config.AccountConfig.OperationalPayableGeneralCashDeposit,
