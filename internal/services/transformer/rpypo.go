...
type rpypoTransformer struct {
	baseWalletTransactionTransformer
}

func (t rpypoTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
