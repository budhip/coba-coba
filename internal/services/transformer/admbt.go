...
type admbtTransformer struct {
	baseWalletTransactionTransformer
}

func (t admbtTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
