...
type admtpTransformer struct {
	baseWalletTransactionTransformer
}

func (t admtpTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
