...
// wolpbTransformer is a transformer to acuan transaction for WOLPB transaction type
type wolpbTransformer struct {
	baseWalletTransactionTransformer
}

func (t wolpbTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
