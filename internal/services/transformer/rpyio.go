...
type rpyioTransformer struct {
	baseWalletTransactionTransformer
}

func (t rpyioTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
