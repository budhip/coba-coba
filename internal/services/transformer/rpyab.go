...
type rpyabTransformer struct {
	baseWalletTransactionTransformer
}

func (t rpyabTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
