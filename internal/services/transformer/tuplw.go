...
// tuplwTransformer is a transformer to acuan transaction for TUPLW transaction type
type tuplwTransformer struct {
	baseWalletTransactionTransformer
}

func (t tuplwTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
