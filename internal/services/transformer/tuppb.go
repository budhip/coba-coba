...
// tuppbTransformer is a transformer to acuan transaction for TUPPB transaction type
type tuppbTransformer struct {
	baseWalletTransactionTransformer
}

func (t tuppbTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
