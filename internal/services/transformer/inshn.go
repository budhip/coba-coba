...
type inshnTransformer struct {
	baseWalletTransactionTransformer
}

func (t inshnTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
