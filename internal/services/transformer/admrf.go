...
type admrfTransformer struct {
	baseWalletTransactionTransformer
}

func (t admrfTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
