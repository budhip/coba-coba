...
type paypmTransformer struct {
	baseWalletTransactionTransformer
}

func (t paypmTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
