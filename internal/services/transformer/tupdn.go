...
type tupdnTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupdnTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
