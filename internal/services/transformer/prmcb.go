...
type prmcbTransformer struct {
	baseWalletTransactionTransformer
}

func (t prmcbTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			FromAccount:     t.config.AccountConfig.DepositCampaignBudget,
