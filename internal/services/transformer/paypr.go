...
type payprTransformer struct {
	baseWalletTransactionTransformer
}

func (t payprTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
