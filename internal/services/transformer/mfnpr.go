...
type mfnprTransformer struct {
	baseWalletTransactionTransformer
}

func (t mfnprTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
