...
type dsbpoTransformer struct {
	baseWalletTransactionTransformer
}

func (t dsbpoTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
