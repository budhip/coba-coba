...
type admmdTransformer struct {
	baseWalletTransactionTransformer
}

func (t admmdTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
