...
type admocTransformer struct {
	baseWalletTransactionTransformer
}

func (t admocTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
