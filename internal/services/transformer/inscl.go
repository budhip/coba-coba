...
type insclTransformer struct {
	baseWalletTransactionTransformer
}

func (t insclTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
