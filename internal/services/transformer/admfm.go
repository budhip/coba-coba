...
type admfmTransformer struct {
	baseWalletTransactionTransformer
}

func (t admfmTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
