...
type admrpTransformer struct {
	baseWalletTransactionTransformer
}

func (t admrpTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			FromAccount:     t.config.AccountConfig.OperationalReceivableDigiasia,
