...
type inspaTransformer struct {
	baseWalletTransactionTransformer
}

func (t inspaTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
