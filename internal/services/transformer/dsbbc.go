...
type dsbbcTransformer struct {
	baseWalletTransactionTransformer
}

func (t dsbbcTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
