...
type payflTransformer struct {
	baseWalletTransactionTransformer
}

func (t payflTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
