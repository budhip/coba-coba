...
type admafTransformer struct {
	baseWalletTransactionTransformer
}

func (t admafTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
