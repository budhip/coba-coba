...
type mmwpiTransformer struct {
	baseWalletTransactionTransformer
}

func (t mmwpiTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
