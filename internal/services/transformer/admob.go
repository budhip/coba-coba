...
type admobTransformer struct {
	baseWalletTransactionTransformer
}

func (t admobTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
