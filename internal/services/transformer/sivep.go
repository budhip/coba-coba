...
type sivepTransformer struct {
	baseWalletTransactionTransformer
}

func (t sivepTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
