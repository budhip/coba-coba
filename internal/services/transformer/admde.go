...
type admdeTransformer struct {
	baseWalletTransactionTransformer
}

func (t admdeTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
