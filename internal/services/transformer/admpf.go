...
type admpfTransformer struct {
	baseWalletTransactionTransformer
}

func (t admpfTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
