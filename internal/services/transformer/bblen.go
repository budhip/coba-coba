...
type bblenTransformer struct {
	baseWalletTransactionTransformer
}

func (t bblenTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
