...
type admpeTransformer struct {
	baseWalletTransactionTransformer
}

func (t admpeTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
