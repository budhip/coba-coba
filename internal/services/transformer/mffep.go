...
type mffepTransformer struct {
	baseWalletTransactionTransformer
}

func (t mffepTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
