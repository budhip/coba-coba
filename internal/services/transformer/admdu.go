...
type admduTransformer struct {
	baseWalletTransactionTransformer
}

func (t admduTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
