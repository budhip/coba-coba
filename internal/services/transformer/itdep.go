...
type itdepTransformer struct {
	baseWalletTransactionTransformer
}

func (t itdepTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
