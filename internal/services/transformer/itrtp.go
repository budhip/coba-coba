...
type itrtpTransformer struct {
	baseWalletTransactionTransformer
}

func (t itrtpTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
