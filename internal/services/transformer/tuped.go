...
type tupedTransformer struct {
	baseWalletTransactionTransformer
}

func (t tupedTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
