...
type mfnpcTransformer struct {
	baseWalletTransactionTransformer
}

func (t mfnpcTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
