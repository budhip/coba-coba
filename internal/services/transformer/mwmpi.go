...
type mwmpiTransformer struct {
	baseWalletTransactionTransformer
}

func (t mwmpiTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
