...
type cotrcTransformer struct {
	baseWalletTransactionTransformer
}

func (t cotrcTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
