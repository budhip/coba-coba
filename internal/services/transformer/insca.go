...
type inscaTransformer struct {
	baseWalletTransactionTransformer
}

func (t inscaTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
