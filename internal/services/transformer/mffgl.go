...
type mffglTransformer struct {
	baseWalletTransactionTransformer
}

func (t mffglTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
