...
type rfdmtTransformer struct {
	baseWalletTransactionTransformer
}

func (t rfdmtTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
