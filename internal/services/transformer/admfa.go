...
type admfaTransformer struct {
	baseWalletTransactionTransformer
}

func (t admfaTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
	...
	return []models.TransactionReq{
		{
			...
			ToAccount:       t.config.AccountConfig.AccountNumberBankForADMFA,
