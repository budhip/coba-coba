...
type paydpTransformer struct {
	baseWalletTransactionTransformer
}

func (t paydpTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
