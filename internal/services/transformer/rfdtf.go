...
type rfdtfTransformer struct {
	baseWalletTransactionTransformer
}

func (t rfdtfTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
