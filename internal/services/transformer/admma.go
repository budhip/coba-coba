...
type admmaTransformer struct {
	baseWalletTransactionTransformer
}

func (t admmaTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
