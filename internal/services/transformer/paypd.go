...
type paypdTransformer struct {
	baseWalletTransactionTransformer
}

func (t paypdTransformer) Transform(_ context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
