...
type admbiTransformer struct {
	baseWalletTransactionTransformer
}

func (t admbiTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
