...
type admddTransformer struct {
	baseWalletTransactionTransformer
}

func (t admddTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
