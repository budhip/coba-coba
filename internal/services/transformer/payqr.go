...
type payqrTransformer struct {
	baseWalletTransactionTransformer
}

func (t payqrTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
