...
type admwpTransformer struct {
	baseWalletTransactionTransformer
}

func (t admwpTransformer) Transform(ctx context.Context, amount models.Amount, parentWalletTransaction models.WalletTransaction) (res []models.TransactionReq, err error) {
